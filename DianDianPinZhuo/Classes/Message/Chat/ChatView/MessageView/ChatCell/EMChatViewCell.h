...
@class EMChatViewCell;
@protocol EMChatViewCellDelegate <NSObject>

@optional
- (void)EMChatViewCell:(EMChatViewCell *)cell didClickIconFromUsername:(NSString *)username;

@end

@interface EMChatViewCell : EMChatViewBaseCell
@property (nonatomic, weak) id<EMChatViewCellDelegate> delegate;
//sender
