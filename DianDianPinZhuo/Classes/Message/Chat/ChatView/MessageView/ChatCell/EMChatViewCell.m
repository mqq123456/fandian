...
- (void)tapClick
{
//    if ([self.delegate respondsToSelector:@selector(EMChatViewCell:didClickIconFromUsername:)]) {
//        [self.delegate EMChatViewCell:self didClickIconFromUsername:self.messageModel.username];
//    }
    if ([self.delegate respondsToSelector:@selector(EMChatViewCell:didClickIconFromUsername:)]) {
        [self.delegate EMChatViewCell:self didClickIconFromUsername:self.messageModel.username];
    }
