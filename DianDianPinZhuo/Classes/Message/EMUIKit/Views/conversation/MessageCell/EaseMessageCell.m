        ...
        switch (model.bodyType) {
            case eMessageBodyType_Text:
            {
                ...
                if ([model.message.ext[@"type"] isEqualToString:@"1"]||[model.message.ext[@"type"] isEqualToString:@"2"]||[model.message.ext[@"type"] isEqualToString:@"3"]||[model.message.ext[@"type"] isEqualToString:@"4"]||[model.message.ext[@"type"] isEqualToString:@"5"]||[model.message.ext[@"type"] isEqualToString:@"6"]||[model.message.ext[@"type"] isEqualToString:@"7"]||[model.message.ext[@"type"] isEqualToString:@"8"]) {
                    ...
                    _bubbleView.bgView.hidden = NO;
                    _bubbleView.content.hidden = NO;
                    _bubbleView.iconImage.hidden = NO;
                    _bubbleView.lineView.hidden = NO;
                    _bubbleView.confirmBtn.hidden = NO;
                    _bubbleView.arrowImage.hidden = NO;
                    _bubbleView.content.text = model.message.ext[@"content"];
                    
                    if ([model.message.ext[@"type"] isEqualToString:@"6"]) {
                       [_bubbleView.confirmBtn setTitle:@"立即查看" forState:UIControlStateNormal];
                    }else{
                     [_bubbleView.confirmBtn setTitle:model.message.ext[@"confirm"] forState:UIControlStateNormal];
                    
                    }
                   
                    
                    switch ([model.message.ext[@"type"] integerValue]) {
                        case 1:
                            [_bubbleView.iconImage setImage:[UIImage imageNamed:@"bow_ico_jiaruquzu_nor"]];
                            break;
                        case 2:
                            [_bubbleView.iconImage setImage:[UIImage imageNamed:@"bow_ico_songdikouquan_nor"]];
                            break;
                        case 3:
                            [_bubbleView.iconImage setImage:[UIImage imageNamed:@"bow_ico_songdikouquan_nor"]];
                            break;
                    ...
                    _bubbleView.bgView.hidden = YES;
                    _bubbleView.content.hidden = YES;
                    _bubbleView.iconImage.hidden = YES;
                    _bubbleView.lineView.hidden = YES;
                    _bubbleView.confirmBtn.hidden = YES;
                    _bubbleView.arrowImage.hidden = YES;
                    _bubbleView.content.text = @"";
                    [_bubbleView.confirmBtn setTitle:@"" forState:UIControlStateNormal];
                    [_bubbleView.iconImage setImage:[UIImage imageNamed:@""]];
                }
            ...
            case eMessageBodyType_Image:
            {
                ...
                if (!image) {
                    image = _model.image;
                    if (!image) {
                        [_bubbleView.imageView sd_setImageWithURL:[NSURL URLWithString:_model.fileURLPath] placeholderImage:[UIImage imageNamed:_model.failImageName] completed:^(UIImage *image, NSError *error, EMSDImageCacheType cacheType, NSURL *imageURL) {
...
//                    }
            ...
            case eMessageBodyType_Video:
            {
                ...
                if (!image) {
                    image = _model.image;
                    if (!image) {
                        [_bubbleView.videoImageView sd_setImageWithURL:[NSURL URLWithString:_model.fileURLPath] placeholderImage:[UIImage imageNamed:_model.failImageName]completed:^(UIImage *image, NSError *error, EMSDImageCacheType cacheType, NSURL *imageURL) {
