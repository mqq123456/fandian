...
@implementation FDCommentDetailFrame
- (void)setStatus:(CommentModel *)status
{
    ...
    CGFloat timeW = 230;
    CGFloat timeH = 20;
    self.timeF = CGRectMake(nick_nameX, CGRectGetMaxY(self.nick_nameF)+5, timeW, timeH);
    ...
    self.replyF = CGRectMake(iconX, CGRectGetMaxY(self.iconF)+5, cellW-iconX-iconX, replyRect.size.height);
    ...
    if ([status.service_response isEqualToString:@""]||status.service_response==nil) {
        self.cellHeight = CGRectGetMaxY(self.imageF)+15;
        ...
        /* cell的高度 */
        self.cellHeight = CGRectGetMaxY(self.content_viewF)+15;
    }
