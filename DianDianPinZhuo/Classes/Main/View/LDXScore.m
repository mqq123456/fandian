...
- (void)handleSingleTap:(id)sender
{
    if (_isSelect) {
        ...
        if (pt.x > _padding) {
            ...
            NSDictionary *dict =[[NSDictionary alloc] initWithObjectsAndKeys:[NSString stringWithFormat:@"%ld",(long)self.show_star],@"star", nil];
            //创建通知
            NSNotification *notification =[NSNotification notificationWithName:@"star" object:nil userInfo:dict];
            //通过通知中心发送通知
