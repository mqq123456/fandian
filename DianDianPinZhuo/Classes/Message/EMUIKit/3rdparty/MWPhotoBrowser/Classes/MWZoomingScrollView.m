...
- (id)initWithPhotoBrowser:(MWPhotoBrowser *)browser {
    if ((self = [super init])) {
        ...
        UILongPressGestureRecognizer *tap = [[UILongPressGestureRecognizer alloc]initWithTarget:self action:@selector(imageSave:)];
...
- (void)imageSave:(UILongPressGestureRecognizer *)longTap{
    switch (longTap.state) {
        ...
        case UIGestureRecognizerStateBegan: // 手势开始（刚检测到长按）
            {
                UIActionSheet *sheet;
                sheet=[[UIActionSheet alloc] initWithTitle:nil delegate:self cancelButtonTitle:@"取消" destructiveButtonTitle:nil otherButtonTitles:@"保存到本地相册", nil];
