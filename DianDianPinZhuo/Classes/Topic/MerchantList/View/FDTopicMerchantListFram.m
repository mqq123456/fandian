...
@implementation FDTopicMerchantListFram
...
- (void)setStatus:(MerchantModel *)status
{
    ...
    if (status.set_meal_arr.count>=2) {
        ...
        self.taocan_label1F =  CGRectMake(CGRectGetMaxX(self.bao_image1F)+3, 0, taocan_label1Rect.size.width, taocan_viewH);
        CGFloat xin_imageW = 15;
        CGFloat xin_imageY = 16.5;
        CGFloat xin_imageH = 15;
        if ([seat.menu_is_new intValue]==1) {
            self.xin_image1F =  CGRectMake(CGRectGetMaxX(self.taocan_label1F)+3, xin_imageY, xin_imageW, xin_imageH);
        }else{
            self.xin_image1F =  CGRectMake(CGRectGetMaxX(self.taocan_label1F)+3, xin_imageY, 0, 0);
        }
        ...
        self.taocan_label2F = CGRectMake(CGRectGetMaxX(self.bao_image2F)+3, 0, taocan_label2Rect.size.width, taocan_viewH);
        
        if ([seat1.menu_is_new intValue]==1) {
            self.xin_image2F =  CGRectMake(CGRectGetMaxX(self.taocan_label2F)+3,  xin_imageY, xin_imageW, xin_imageH);
    ...
    if ([status.sold_out intValue]==1) {
        ...
        if ([status.order_seat intValue]==0) {
            ...
            self.people_yudingF = CGRectMake(CGRectGetMaxX(self.yiyou_peopleF), 0, 100, bottomH);
        }else{
    ...
    /** originalViewF */
    CGRect  meirenRect = [@"元/人" boundingRectWithSize:CGSizeMake(200, bottomH) options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName:priceFont1} context:nil];
    self.meirenF = CGRectMake(cellW-18-meirenRect.size.width, 0, meirenRect.size.width, bottomH);
    
    CGRect  priceRect = [[NSString stringWithFormat:@"%@",status.price] boundingRectWithSize:CGSizeMake(200, bottomH) options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName:priceFont1} context:nil];
    self.priceF = CGRectMake(cellW-meirenRect.size.width-priceRect.size.width-18, 0, priceRect.size.width, bottomH);
    ...
    self.distanceF = CGRectMake(10, 0, distanceRect.size.width, bottomH);
    
    self.distance_imageF = CGRectMake(0, (bottomH-9)/2, 7.5, 9);
