...
#import "HQConst.h"
#import "HQHttpTool.h"
@implementation HttpUserAdNotify
#pragma mark -  获取单例对象
static id _instace;
...
-  (void)loadUserAdNotifyWithAd_id:(NSString *)ad_id{
    ...
    ReqUserAdNotifyModel *reqModel =[[ReqUserAdNotifyModel alloc]init];
    reqModel.kid = [HQDefaultTool getKid];
    reqModel.ad_id = ad_id;
    ApiPaseUserAdNotify *request=[[ApiPaseUserAdNotify alloc]init];
