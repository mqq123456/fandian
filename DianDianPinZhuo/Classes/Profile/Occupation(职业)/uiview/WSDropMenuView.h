...
@property(nonatomic,assign)NSInteger left_Pre;
@property(nonatomic,assign)NSInteger left_Select;
@property(nonatomic,assign)NSInteger right_Pre;
@property(nonatomic,assign)NSInteger right_Select;
@property(nonatomic,assign)NSInteger currSelectColumn;
@property(nonatomic,assign)NSInteger currSelectRow;
@property(nonatomic,assign)NSInteger currSelectItem;
