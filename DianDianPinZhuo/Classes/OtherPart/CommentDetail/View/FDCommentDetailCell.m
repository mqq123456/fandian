...
@implementation FDCommentDetailCell
...
- (void)setStatusFrame:(FDCommentDetailFrame *)statusFrame
{
...
+ (instancetype)cellWithTableView:(UITableView *)tableView{
    static NSString *ID = @"FDCommentDetailCell";
    FDCommentDetailCell *cell = [tableView dequeueReusableCellWithIdentifier:ID];
    
    if (cell == nil) {
        
       cell = [[FDCommentDetailCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:ID];
