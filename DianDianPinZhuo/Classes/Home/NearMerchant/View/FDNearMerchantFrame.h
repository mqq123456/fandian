...
#define original_price_font [UIFont systemFontOfSize:13]



@class MerchantModel;
@interface FDNearMerchantFrame : NSObject
...
/** 套餐1 */
@property (nonatomic, assign) CGRect original_price1F;
/** 套餐2 */
@property (nonatomic, assign) CGRect original_price2F;
